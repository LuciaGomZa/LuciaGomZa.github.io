/** 
*  ----------------------------------------------
*  |    Práctica GPC #5. Luces y materiales     |
*  ----------------------------------------------
*/
...
function loadScene(){
    ...
    var texturaMate = new THREE.TextureLoader().load(path+'metal_128x128.jpg');
    ...
    // |    Material     |
    // -------------------
    materialSuelo = new THREE.MeshLambertMaterial({color:'white', map: texturaSuelo});
    materialMate = new THREE.MeshLambertMaterial({color:'white', map: texturaMate});
    materialMadera = new THREE.MeshLambertMaterial({color:'white', map: texturaMadera});
    materialRotula = new THREE.MeshPhongMaterial({color:'white', specular:'white', shininess: 50, envMap:mapaEntorno });
    ...
    base = new THREE.Mesh(geoBase, materialMate);
    ...
    var mano = new THREE.Mesh(geoMano, materialMadera);
