...
function init(){
    ...
    camera = new THREE.PerspectiveCamera (40, ar, 0.1, 1500); // Cámara de tipo perspectiva (fov, razonAspecto, cerca, lejos)
    camera.position.set(350, 300, 350); // Punto en el que se fija la cámara
    camera.lookAt(new THREE.Vector3(0, 100, 0)); // Punto de interés hacia el que mira la cámara
    scene.add(camera); 
}
